...
RUN cp /files/galaxy/tools/isacreator_metabo/isacreator_metabo.py /usr/local/bin/isacreator_metabo.py
RUN chmod a+x /usr/local/bin/isacreator_metabo.py

ENTRYPOINT ["isacreator_metabo.py"]
